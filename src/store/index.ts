...
export const useStore = create<StoreState>((set) => ({
  ...
  addRecipe: (r) => set((s) => ({ recipes: [{ ...r, id: genId() }, ...s.recipes] })),
  updateRecipe: (id, r) => set((s) => ({ recipes: s.recipes.map(x => x.id === id ? { ...x, ...r } : x) })),
  addFeeding: (f) => set((s) => ({ feedings: [{ ...f, id: genId() }, ...s.feedings] })),
  addElectrodeFill: (f) => set((s) => ({ electrodeFills: [{ ...f, id: genId() }, ...s.electrodeFills] })),
  addElectrodeRelease: (f) => set((s) => ({ electrodeReleases: [{ ...f, id: genId() }, ...s.electrodeReleases] })),
  addTapping: (t) => set((s) => ({ tappings: [{ ...t, id: genId() }, ...s.tappings] })),
  addCasting: (c) => set((s) => ({ castings: [{ ...c, id: genId() }, ...s.castings] })),
  addCrushing: (c) => set((s) => ({ crushings: [{ ...c, id: genId() }, ...s.crushings] })),
  addGasTest: (g) => set((s) => ({ gasTests: [{ ...g, id: genId() }, ...s.gasTests] })),
  addStorage: (s2) => set((s) => ({ storages: [{ ...s2, id: genId() }, ...s.storages] })),
}));
